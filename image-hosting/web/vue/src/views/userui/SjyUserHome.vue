    ...
    <div class="dialog-content-wrapper" v-if="selectedImage">
      ...
      <div class="dialog-body-custom">
        <el-row :gutter="20" style="width: 100%; height: 100%;">
            ...
            <img :src="MINIO_SERVER_PORT + selectedImage.minioUrl" :alt="selectedImage.fileName" class="full-image">
...
import ChallengesPage from '@/views/userui/components/SjyChallengesComponent.vue'; // 导入 ChallengesPage 组件
